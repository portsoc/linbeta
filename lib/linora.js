...
window.linora.ui = (function () {
     ...
     */
        ...
        feedbackMeta = function (meta) {
            if (meta.msg && (meta.display === undefined || meta.display === true)) {
                window.linora.feedback.log(
                    meta.msg,
                    "cls" + meta.ok
                );
            }
